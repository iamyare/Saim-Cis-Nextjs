...
import { updatePersona, uploadAvatar } from '@/app/actions'
...
export default function ActualizarPerfil ({ usuario }: { usuario: UserType }) {
  let avatarUrl = usuario?.usuario.avatar_url ?? 'https://leplanb.lesmontagne.net/wp-content/uploads/sites/5/2017/06/default_avatar.png'
