    ...
    <div className="-m-1.5 overflow-x-auto">
        ...
        <div className="border rounded-lg overflow-hidden dark:border-gray-700">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead>
                <tr>
                    <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-600 dark:text-gray-400  uppercase"><div className="h-4 bg-gray-200 rounded w-1/2"></div></th>
                    <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-600 dark:text-gray-400 uppercase"><div className="h-4 bg-gray-200 rounded w-1/2"></div></th>
                    <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-600 dark:text-gray-400 uppercase"><div className="h-4 bg-gray-200 rounded w-1/2"></div></th>
                    <th scope="col" className="px-6 py-3 text-end text-xs font-medium text-gray-600 dark:text-gray-400 uppercase"><div className="h-4 bg-gray-200 rounded w-1/2"></div></th>
                    <th scope="col" className="px-6 py-3 text-end text-xs font-medium text-gray-600 dark:text-gray-400 uppercase"><div className="h-4 bg-gray-200 rounded w-1/2"></div></th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <div className="hs-dropdown w-6 h-6 bg-gray-200 rounded"></div>
                    </td>
                </tr>
                <tr>
                    <td className="whitespace-nowrap py-4 pl-2 pr-3 flex items-center gap-4">
