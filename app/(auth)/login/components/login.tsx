...
export default function LoginAuth () {
  return (
    ...
    <img className='absolute inset-0 bg-cover w-full h-full' src="https://kvcvdthsaepnfxzhvtmy.supabase.co/storage/v1/object/public/imagenes/Landing/Landing%204.webp" alt="" />
