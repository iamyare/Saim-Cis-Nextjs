...
export default function Nosotros() {
  return (
    <>
      {/* <section className="container mx-auto py-4 my-2" id="nosotros">
        <div className="mx-auto grid max-w-7xl gap-y-5 px-6 lg:px-8 ">
          ...
          <div className="relative flex  flex-col justify-center overflow-hidden bg-gray-50 dark:bg-transparent py-2 sm:py-6">
              ...
              <div className="group grid w-full grid-cols-2">
                ...
                <div className="pl-16 relative flex items-end flex-col before:block before:absolute before:h-1/6 before:w-4 before:bg-blue-500 before:bottom-0 before:left-0 before:rounded-lg  before:transition-all group-hover:before:bg-orange-300 overflow-hidden">
                  ...
                  <div className="rounded-xl overflow-hidden">
                    <img
                      src="https://kvcvdthsaepnfxzhvtmy.supabase.co/storage/v1/object/public/imagenes/Landing/Landing%203.webp"
                      alt=""
                    />
                  </div>
                </div>
